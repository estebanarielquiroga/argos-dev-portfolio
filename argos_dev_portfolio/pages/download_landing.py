...
@rx.page(route="/soluciones/gestion-sanciones", title="Sistema de Gestión de Sanciones | Argos-Dev")
def macro_nomina_landing() -> rx.Component:
    return layout(
        rx.vstack(
            rx.heading("Sistema de Gestión de Sanciones", size="9", style=heading_style, color=Color.TEXT, text_align="center"),
            rx.text(
                "Herramienta profesional para el registro y seguimiento administrativo de sanciones institucionales.",
            ...
            rx.grid(
                rx.vstack(
                    ...
                    rx.list.unordered(
                        rx.list.item("Registro centralizado de faltas y sanciones."),
                        rx.list.item("Generación automática de documentos y actas."),
                        rx.list.item("Historial detallado por agente/empleado."),
                        rx.list.item("Interfaz intuitiva optimizada para Access Runtime."),
                        color=Color.TEXT_MUTED,
                        spacing="3"
                    ),
                    
                    rx.heading("Seguridad y Control", size="6", style=heading_style, margin_top="1em"),
                    rx.text("Garantiza la integridad de los datos administrativos y facilita auditorías rápidas de procesos disciplinarios.", color=Color.TEXT_MUTED),
